...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-workspace-file-drag': { kind: 'indirect', reason: 'The user gesture inserts a standard reference whose existing source owns model serialization.' },
